...
export const answersC: SecurityQuestion[] = [
  {
    ...
    requirement: "1.2.1",
    issueIfNotCompliant:
      "Unrestricted inbound traffic can increase vulnerability to attacks.",
    remediation:
      "Implement firewall rules to restrict inbound traffic to the CDE to only that which is necessary, denying all other traffic.",
  },
  {
    question:
    ...
    requirement: "1.3.4",
    issueIfNotCompliant:
      "Unrestricted outbound traffic can lead to data leakage and breaches.",
    remediation:
      "Configure network devices to allow only necessary outbound traffic from the CDE, thereby reducing risk.",
  },
  {
    ...
    requirement: "1.3.4",
    issueIfNotCompliant:
      "Failure to specifically deny certain types of traffic can lead to security vulnerabilities.",
    remediation:
      "Ensure all non-essential outbound traffic types are explicitly denied to protect the CDE from unauthorized access or data exfiltration.",
  },
  {
    question:
    ...
    requirement: "1.2.3",
    issueIfNotCompliant:
      "Lack of NSCs can allow unauthorized access to the CDE via wireless networks.",
    remediation:
      "Install robust NSCs between wireless networks and the CDE to prevent unauthorized access and ensure secure data transmission.",
  },
  {
    question:
    ...
    requirement: "1.2.3",
    issueIfNotCompliant:
      "Default allowance of wireless traffic increases the risk of unauthorized access.",
    remediation:
      "Set up systems to deny all wireless traffic to the CDE by default, allowing only authorized and secure wireless connections.",
  },
  {
    question:
    ...
    requirement: "1.2.3",
    issueIfNotCompliant:
      "Unauthorized wireless access can pose significant security risks.",
    remediation:
      "Ensure that wireless traffic is permitted into the CDE strictly for authorized business purposes, with stringent security measures in place.",
  },
  {
    question:
    ...
    requirement: "12.1, 2",
    issueIfNotCompliant:
      "Undocumented policies can lead to inconsistent implementation and security gaps.",
    remediation:
      "Document all security policies and operational procedures related to Requirement 2, ensuring clarity and accessibility for relevant personnel.",
  },
  {
    ...
    requirement: "12.1, 2",
    issueIfNotCompliant:
      "Outdated policies and procedures may not address current threats effectively.",
    remediation:
      "Regularly review and update security policies and procedures related to Requirement 2 to ensure their relevance and effectiveness.",
  },
  {
    ...
    requirement: "12.1, 2",
    issueIfNotCompliant:
      "Policies not actively followed can lead to security breaches and compliance issues.",
    remediation:
      "Ensure that security policies and procedures for Requirement 2 are actively implemented and adhered to within the organization.",
  },
  {
    question:
    ...
    requirement: "12.1, 2",
    issueIfNotCompliant:
      "Lack of awareness can result in non-compliance and security lapses.",
    remediation:
      "Communicate all relevant policies and procedures to all affected parties, ensuring widespread understanding and compliance.",
  },
  {
    question:
    ...
    requirement: "2.2",
    issueIfNotCompliant:
      "Without configuration standards, systems may be vulnerable to exploitation.",
    remediation:
      "Develop comprehensive configuration standards for all system components, addressing security vulnerabilities and ensuring secure setup.",
  },
  {
    ...
    requirement: "2.2, 6.1",
    issueIfNotCompliant:
      "Standards not addressing all vulnerabilities can leave systems exposed.",
    remediation:
      "Ensure configuration standards address all known security vulnerabilities, keeping them updated as new threats emerge.",
  },
  {
    question:
    ...
    requirement: "2.2",
    issueIfNotCompliant:
      "Non-compliance with industry standards can result in inadequate security controls.",
    remediation:
      "Align configuration standards with industry-accepted system hardening standards to ensure robust security measures.",
  },
  {
    question:
    ...
    requirement: "6.2",
    issueIfNotCompliant:
      "Failure to update standards can lead to persistent vulnerabilities.",
    remediation:
      "Regularly update configuration standards as new vulnerabilities are identified, ensuring continuous improvement of security measures.",
  },
  {
    question:
    ...
    requirement: "2.2",
    issueIfNotCompliant:
      "Systems not configured per standards may introduce security weaknesses.",
    remediation:
      "Configure and verify new systems according to established standards before their connection to the production environment.",
  },
  {
    ...
    remediation:
      "Change default passwords and implement strict management and monitoring for vendor default accounts if they are to be used.",
  },
  {
    question:
  ...
  },
  {
    ...
    remediation:
      "Manage primary functions on system components by segregating duties and applying different security levels as needed for risk mitigation.",
  },
  {
    question:
    ...
    requirement: "2.2.2",
    issueIfNotCompliant:
      "Unnecessary services can introduce additional vulnerabilities.",
    remediation:
      "Disable all unnecessary services, protocols, daemons, and functions to minimize potential attack surfaces.",
  },
  {
    ...
    requirement: "2.2.2",
    issueIfNotCompliant:
      "Superfluous functionalities can be exploited by attackers.",
    remediation:
      "Remove or disable any functionalities not required for the specific purpose of the system to enhance security.",
  },
  {
    question:
    ...
    requirement: "2.2.2",
    issueIfNotCompliant:
      "Use of insecure elements without justification increases risk.",
    remediation:
      "Document the business justification for using any insecure services, protocols, or daemons, evaluating the necessity and risk.",
  },
  {
    question:
    ...
    requirement: "2.2.2",
    issueIfNotCompliant:
      "Insecure elements without additional security can be vulnerable.",
    remediation:
      "Implement compensating security controls when using insecure services, protocols, or daemons to mitigate potential risks.",
  },
  {
    question:
    ...
    requirement: "2.2.5",
    issueIfNotCompliant:
      "Misconfigured parameters can lead to system exploitation.",
    remediation:
      "Configure system security parameters properly to prevent misuse and unauthorized access, following best practices for security.",
  },
  {
    question:
    ...
    requirement: "2.3",
    issueIfNotCompliant:
      "Unencrypted administrative access can lead to data interception and compromise.",
    remediation:
      "Encrypt all non-console administrative access using strong cryptographic techniques to ensure secure communications.",
  },
  {
    question:
    ...
    remediation:
      "Change all default settings, including passwords and SSIDs, on wireless devices before using them in environments connected to the CDE or transmitting account data.",
  },
  {
    question:
    ...
    requirement: "4.1.1",
    issueIfNotCompliant:
      "Stagnant encryption keys can be compromised over time.",
    remediation:
      "Implement a process to regularly change wireless encryption keys, especially after any security incidents or personnel changes.",
  },
  {
    question:
    ...
    issueIfNotCompliant:
      "Undocumented policies can lead to inconsistent implementation and security gaps.",
    remediation:
      "Document all security policies and operational procedures related to Requirement 3, ensuring clarity and accessibility for relevant personnel.",
  },
  {
    ...
    issueIfNotCompliant:
      "Outdated policies and procedures may not address current threats effectively.",
    remediation:
      "Regularly review and update security policies and procedures related to Requirement 3 to ensure their relevance and effectiveness.",
  },
  {
    question:
    ...
    issueIfNotCompliant:
      "Policies not actively followed can lead to security breaches and compliance issues.",
    remediation:
      "Ensure that security policies and procedures for Requirement 3 are actively implemented and communicated to all affected parties.",
  },
  {
    question:
    ...
    requirement: "3.2",
    issueIfNotCompliant:
      "Retention of SAD post-authorization is a major security risk.",
    remediation:
  ...
  },
  {
    ...
    requirement: "4.1",
    issueIfNotCompliant:
      "PAN transmitted without strong cryptography can be intercepted and compromised.",
    remediation:
      "Use strong cryptography and secure transmission protocols (like TLS) to protect PAN during transmission over open, public networks.",
  },
  {
    question:
    ...
    requirement: "4.1",
    issueIfNotCompliant:
      "Accepting untrusted keys and certificates can compromise transmission security.",
    remediation:
      "Ensure that only trusted keys and certificates are used for encrypting PAN during transmission to validate authenticity and security.",
  },
  {
    question:
    ...
    requirement: "4.1",
    issueIfNotCompliant:
      "Using invalid or expired certificates can lead to security vulnerabilities.",
    remediation:
      "Regularly check and validate certificates used for PAN encryption to ensure they are current and have not been revoked.",
  },
  {
    question:
    ...
    requirement: "4.1",
    issueIfNotCompliant:
      "Insecure or outdated protocol versions increase the risk of data breaches.",
    remediation:
      "Use only secure and up-to-date versions of transmission protocols, ensuring they are configured for maximum security.",
  },
  {
    question:
    ...
    requirement: "4.1",
    issueIfNotCompliant:
      "Inadequate encryption strength can be easily breached.",
    remediation:
      "Ensure that the encryption strength is appropriate and aligned with the encryption methodology employed, following current best practices.",
  },
  {
    question:
    ...
    requirement: "4.1",
    issueIfNotCompliant:
      "Weak cryptography in wireless networks can be exploited.",
    remediation:
      "Implement strong cryptographic techniques for both authentication and transmission of PAN over wireless networks.",
  },

  {
    ...
    requirement: "4.2",
    issueIfNotCompliant:
      "Sending PAN via unsecured messaging technologies can lead to data interception.",
    remediation:
      "Ensure that PAN is encrypted with strong cryptography when sent using end-user messaging technologies, protecting it from unauthorized access.",
  },
  {
    question:
    ...
    issueIfNotCompliant:
      "Undocumented policies can lead to inconsistent implementation and security gaps.",
    remediation:
      "Document all security policies and operational procedures related to Requirement 5, ensuring clarity and accessibility for relevant personnel.",
  },
  {
    question: "Are these documents kept up to date?",
    domain: "Policy Management",
    ...
    issueIfNotCompliant:
      "Outdated policies and procedures may not address current threats effectively.",
    remediation:
      "Regularly review and update security policies and procedures related to Requirement 5 to ensure their relevance and effectiveness.",
  },
  {
    question:
      "Are these policies and procedures in use and known to all affected parties?",
    ...
    issueIfNotCompliant:
      "Policies not actively followed can lead to security breaches and compliance issues.",
    remediation:
      "Ensure that security policies and procedures for Requirement 5 are actively implemented and communicated to all affected parties.",
  },
  {
    ...
    requirement: "5.1",
    issueIfNotCompliant:
      "Absence of anti-malware solutions can leave systems vulnerable to malware attacks.",
    remediation:
      "Deploy an effective anti-malware solution on all system components, particularly those susceptible to malware.",
  },
  {
    question:
    ...
    requirement: "5.1.2",
    issueIfNotCompliant:
      "Inadequate malware detection can lead to system compromise.",
    remediation:
      "Ensure the anti-malware solution is capable of detecting all known types of malware, keeping it updated to recognize new malware variants.",
  },
  {
    ...
    requirement: "5.1.2",
    issueIfNotCompliant:
      "Failure to effectively remove, block, or contain malware can result in system infections and data breaches.",
    remediation:
      "Configure the anti-malware solution to not only detect but also effectively remove, block, or contain any identified malware.",
  },
  {
    question:
    ...
    requirement: "5.1.2",
    issueIfNotCompliant:
      "Overlooking malware risks on certain components can lead to security oversights.",
    remediation:
      "Periodically evaluate all system components, even those believed to be not at risk for malware, to reassess their risk profile and need for malware protection.",
  },
  {
    question:
    ...
    requirement: "5.1.2",
    issueIfNotCompliant:
      "Infrequent evaluations may miss emerging malware threats.",
    remediation:
      "Establish a frequency for periodic evaluations of all system components to ensure ongoing assessment and response to evolving malware risks.",
  },
  {
    question:
    ...
    requirement: "5.2",
    issueIfNotCompliant:
      "Out-of-date anti-malware solutions may not effectively protect against new malware.",
    remediation:
      "Set up automatic updates for the anti-malware solution to ensure it remains current and effective against the latest malware threats.",
  },
  {
    question:
    ...
    remediation:
      "Ensure the anti-malware solution performs both periodic and real-time scans to actively detect and respond to malware threats.",
  },
  {
    question:
    ...
    remediation:
      "Conduct periodic malware scans at a frequency sufficient to identify and mitigate risks, typically daily or more frequently.",
  },
  {
    question:
    ...
    remediation:
      "Implement procedures to scan removable electronic media for malware upon insertion or connection to system components.",
  },
  {
    question:
    ...
    requirement: "10.5.1",
    issueIfNotCompliant:
      "Without logs, tracking and analyzing malware incidents is challenging.",
    remediation:
      "Ensure that audit logs for the anti-malware solution are enabled, properly maintained, and retained according to PCI DSS requirements.",
  },
  {
    ...
    remediation:
      "Configure anti-malware mechanisms to prevent disabling or alteration by users unless specifically authorized.",
  },
  {
    question:
    ...
    requirement: "5.1, 5.2",
    issueIfNotCompliant:
      "Vulnerability to phishing attacks can lead to data breaches.",
    remediation:
      "Implement processes and automated mechanisms, like email filtering and user training, to detect and protect against phishing attacks.",
  },
  {
    question:
    ...
    remediation:
      "Develop bespoke and custom software securely, adhering to industry standards or best practices for secure coding.",
  },
  {
    question:
    ...
    requirement: "6.5",
    issueIfNotCompliant:
      "Lack of training can lead to security vulnerabilities in software.",
    remediation:
      "Provide relevant training on software security to development personnel, tailored to their specific job functions.",
  },
  {
    question:
    ...
    requirement: "6.3.2",
    issueIfNotCompliant:
      "Poorly managed code reviews can miss critical vulnerabilities.",
    remediation:
      "Implement a structured process for manual code reviews, ensuring thorough examination for security vulnerabilities.",
  },
  {
    question:
    ...
    remediation:
      "Use robust software engineering techniques or methods, such as input validation and error handling, to prevent common software attacks.",
  },
  {
    ...
    requirement: "6.1, 6.2",
    issueIfNotCompliant:
      "Unmanaged vulnerabilities can lead to system exploitation.",
    remediation:
      "Establish a process for identifying, assessing, and managing security vulnerabilities in a timely manner.",
  },
  {
    question:
    ...
    remediation:
      "Regularly consult industry-recognized sources to stay updated on new security vulnerabilities.",
  },
  {
    ...
    requirement: "6.1",
    issueIfNotCompliant:
      "Without risk ranking, it's challenging to prioritize remediation efforts.",
    remediation:
  ...
  },
  {
    ...
    requirement: "6.2",
    issueIfNotCompliant:
      "Neglecting software vulnerabilities can result in breaches.",
    remediation:
      "Include both bespoke/custom and third-party software in your vulnerability management process to ensure comprehensive coverage.",
  },
  {
    ...
    remediation:
      "Implement measures to protect system components from known vulnerabilities, including regular patching and updates.",
  },
  {
